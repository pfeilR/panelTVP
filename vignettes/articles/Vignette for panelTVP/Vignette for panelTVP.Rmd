...
The matrix \texttt{posterior.predictive} is of dimension $N_{new} \times (M\cdot \texttt{n.replicates})$, where $N_{new}$ is the number of new data points. Due to marginalization, there are \texttt{n.replicates} samples for each draw of the Markov Chain. The posterior predictive distribution may then be visualized as
